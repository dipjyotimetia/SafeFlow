import type { LocalSuburbData } from "@/lib/market-data/local";
import type {
  Account,
  Budget,
...
export class SafeFlowDB extends Dexie {
  ...
  marketData!: Table<LocalSuburbData>;
  ...
  constructor() {
    ...
    this.version(1).stores({
      ...
      transactions:
        "id, accountId, categoryId, type, date, importBatchId, [accountId+date]",
    ...
    this.version(2).stores({
      ...
      superTransactions:
        "id, superAccountId, type, date, financialYear, [superAccountId+date]",
    });
    ...
    this.version(4).stores({
      ...
      categorizationQueue: "id, transactionId, status, createdAt",
      merchantPatterns:
        "id, normalizedName, categoryId, confidence, lastUsed, userConfirmed",
    });
    ...
    this.version(5).stores({
      ...
      categories: "id, type, parentId, atoCode, isActive",
      transactions:
        "id, accountId, categoryId, type, date, importBatchId, memberId, [accountId+date]",
      holdings: "id, accountId, symbol, type",
      investmentTransactions: "id, holdingId, type, date",
      taxItems: "id, financialYear, atoCategory, transactionId",
      syncMetadata: "id",
    ...
    this.version(10).stores({
      ...
      properties:
        "id, state, status, purpose, memberId, createdAt, [state+status]",
      propertyLoans: "id, propertyId, lender, createdAt",
      propertyExpenses:
        "id, propertyId, category, financialYear, isRecurring, [propertyId+category], [propertyId+financialYear]",
      propertyRentals:
        "id, propertyId, leaseStartDate, leaseEndDate, [propertyId+leaseStartDate]",
      propertyDepreciation:
        "id, propertyId, financialYear, [propertyId+financialYear]",
    ...
    this.version(11).stores({
      accounts:
        "id, type, isActive, createdAt, memberId, visibility, syncVersion, isDeleted",
      categories:
        "id, type, parentId, atoCode, isActive, syncVersion, isDeleted",
      transactions:
      ...
      investmentTransactions:
        "id, holdingId, type, date, syncVersion, isDeleted, [type+date], [holdingId+date]",
      taxItems:
        "id, financialYear, atoCategory, transactionId, syncVersion, isDeleted",
      syncMetadata: "id",
      importBatches: "id, source, importedAt, syncVersion, isDeleted",
      superannuationAccounts:
        "id, provider, memberNumber, createdAt, syncVersion, isDeleted",
      superTransactions:
        "id, superAccountId, type, date, financialYear, syncVersion, isDeleted, [superAccountId+date], [superAccountId+financialYear]",
      chatConversations: "id, createdAt, updatedAt, syncVersion, isDeleted",
      categorizationQueue:
        "id, transactionId, status, createdAt, syncVersion, isDeleted",
      merchantPatterns:
        "id, normalizedName, categoryId, confidence, lastUsed, userConfirmed, syncVersion, isDeleted",
      budgets:
        "id, categoryId, memberId, period, isActive, createdAt, syncVersion, isDeleted",
      familyMembers: "id, isActive, createdAt, syncVersion, isDeleted",
      goals: "id, type, status, targetDate, createdAt, syncVersion, isDeleted",
      priceHistory:
        "id, holdingId, date, syncVersion, isDeleted, [holdingId+date]",
      portfolioHistory: "id, date, syncVersion, isDeleted",
      // Property portfolio tables
      properties:
        "id, state, status, purpose, memberId, createdAt, syncVersion, isDeleted, [state+status]",
      propertyLoans:
        "id, propertyId, lender, createdAt, syncVersion, isDeleted",
      propertyExpenses:
        "id, propertyId, category, financialYear, isRecurring, syncVersion, isDeleted, [propertyId+category], [propertyId+financialYear]",
      propertyRentals:
        "id, propertyId, leaseStartDate, leaseEndDate, syncVersion, isDeleted, [propertyId+leaseStartDate]",
      propertyDepreciation:
        "id, propertyId, financialYear, syncVersion, isDeleted, [propertyId+financialYear]",
      propertyModels:
        "id, propertyId, isActive, createdAt, syncVersion, isDeleted",
    ...
    this.version(12).stores({
      ...
      budgets:
        "id, categoryId, memberId, period, isActive, createdAt, syncVersion, isDeleted, [categoryId+period]",
      familyMembers: "id, isActive, createdAt, syncVersion, isDeleted",
      goals: "id, type, status, targetDate, createdAt, syncVersion, isDeleted",
      priceHistory:
        "id, holdingId, date, syncVersion, isDeleted, [holdingId+date]",
    ...
    this.version(13).stores({
      ...
      taxLots:
        "id, holdingId, purchaseDate, remainingUnits, transactionId, syncVersion, isDeleted, [holdingId+purchaseDate]",
    });
    ...
    this.version(14).stores({
      ...
      goals:
        "id, type, status, targetDate, createdAt, syncVersion, isDeleted, [syncVersion+isDeleted]",
      priceHistory:
        "id, holdingId, date, syncVersion, isDeleted, [holdingId+date], [syncVersion+isDeleted]",
      portfolioHistory:
        "id, date, syncVersion, isDeleted, [syncVersion+isDeleted]",
      properties:
        "id, state, status, purpose, memberId, createdAt, syncVersion, isDeleted, [state+status], [syncVersion+isDeleted]",
      propertyLoans:
    ...
    // Version 15: Add marketData table and improve indexes
