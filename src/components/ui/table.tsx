...
function TableHeader({ className, ...props }: React.ComponentProps<"thead">) {
  return (
    <thead
      ...
      className={cn(
        "[&_tr]:border-b [&_tr]:border-border [&_th]:bg-background",
        className,
      )}
      {...props}
    />
...
function TableHead({ className, ...props }: React.ComponentProps<"th">) {
  return (
    <th
      ...
      className={cn(
        "h-10 px-3 text-left align-middle font-mono text-[10px] font-medium uppercase tracking-[0.16em] whitespace-nowrap text-[--text-subtle]",
