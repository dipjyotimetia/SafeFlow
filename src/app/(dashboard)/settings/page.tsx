...
export default function SettingsPage() {
  ...
  const setTransactionViewMode = useUIStore(
    (state) => state.setTransactionViewMode,
  );
  const autoRefreshPrices = useUIStore((state) => state.autoRefreshPrices);
  const setAutoRefreshPrices = useUIStore(
    (state) => state.setAutoRefreshPrices,
  );
        ...
        <div className="mx-auto flex w-full max-w-4xl flex-col gap-6 px-4 pt-6 sm:px-6 lg:px-8">
            ...
            <CardContent className="space-y-4">
              <div className="flex items-center justify-between">
                ...
                <Select
                  ...
                  onValueChange={(v) =>
                    setTransactionViewMode(v as "list" | "grouped")
                  }
                >
                  <SelectTrigger className="w-[140px]">
                    <SelectValue />
            ...
            <CardContent className="space-y-4">
              <div className="flex items-center justify-between">
                <div className="space-y-1">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Automatically refresh prices when visiting the Investments
                    page if data is stale (over 1 hour old)
                  </p>
                </div>
                <Switch
              ...
              <div className="pt-2 border-t">
                <p className="text-xs text-muted-foreground">
                  Price data is fetched from Yahoo Finance (ASX stocks/ETFs) and
                  CoinGecko (cryptocurrencies). Prices are stored locally and a
                  30-day history is kept for trend charts.
                </p>
              </div>
            </CardContent>
          </Card>
          ...
          <Card variant="premium">
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <p className="text-xs text-muted-foreground">
                  The Ollama model to use for AI features. Run &quot;ollama pull
                  llama3.1:8b&quot; to download.
                </p>
              </div>
              ...
              <div className="flex items-center justify-between">
                ...
                <Switch
                  ...
                  onCheckedChange={(checked) =>
                    updateAISettings({ autoCategorize: checked })
                  }
                />
              </div>
          ...
          <Card variant="premium">
            ...
            <CardContent className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Privacy-first family finance app for Australians. All data is
                stored locally in your browser and encrypted before syncing to
                cloud storage.
              </p>
            </CardContent>
          </Card>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start gap-2 pt-2">
                  <Checkbox
                    ...
                    onCheckedChange={(checked) =>
                      setConfirmClearData(checked === true)
                    }
                    disabled={isClearing}
                  />
                  <label
